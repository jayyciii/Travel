    ...
    return (
        <div className='space-y-5 bg-white p-8 md:h-[calc(100vh-98px)] flex flex-col justify-between'>
            ...
            <ul className='space-y-5 pt-5'>
                ...
                <li>
                    <NavLink to="/dashboard/manage-comments" className={({isActive}) => isActive ? "text-blue-600 font-bold" : "text-black"}>Manage Comments</NavLink>
                </li>
            </ul>
            </div>
            ...
            <div className='mb-3'>
                ...
                className='text-white bg-red-500 font-medium px-5 py-1 rounded-sm'>Loggout</button>
            </div>
